        ...
        if (data.payment_type === 2) {
            try {
                let newData = {
                    ...
                    // url_callback: 'http://localhost:9998/api/v1/booking/callback'
                }
                const response = await axios.post("https://localhost:9998/api/v1/payment/add", newData);
